...
export default function ArchiveClient({ orders }: { orders: any[] }) {
                        ...
                        {orders.length === 0 ? (
                            ...
                            orders.map((order: any) => (
                                <tr 
                                    ...
                                    className={`bg-white border-b hover:bg-gray-50 cursor-pointer transition-colors ${order.source === "KASPI" ? "border-l-4 border-l-red-400" : ""}`}
                                >
